  ...
  <div className='app__footer section__padding'>
    ...
    <div className="app__footer-links">
      <div className="app__footer-links_contact">
        ...
        <address className="p__opensans">4760 Marsh Road Okemos MI 48864</address>
        <a href="tel: +91 517-483-2280" className="p__opensans">+91 517-483-2280</a><br />
        <a href="tel: +91 517-993-6371" className="p__opensans">+91 517-993-6371</a>
      </div>
      ...
      <div className="app__footer-links_work">
        ...
        <span className="p__opensans">Monday-Friday:</span><br />
        <span className="p__opensans">12:00 am - 10:00 pm</span><br />
        <span className="p__opensans">Saturday-Sunday:</span><br />
